...
const expectedQueryParameters: Record<string, string[]> = {
  ...
  "GET /api/v1/me/trash": ["page", "pageSize"],
  ...
  "GET /api/v1/moderation/revival-requests": ["page", "pageSize"],
  "GET /api/v1/moderation/appeals": ["page", "pageSize"],
...
const expectedRequestBodies: Record<string, string> = {
  ...
  "POST /api/v1/entries/{entryId}/revival-requests": "EntryRevivalRequest",
  ...
  "POST /api/v1/moderation/revival-requests/{requestId}/reject": "EntryReviewDecision",
  "POST /api/v1/moderation/appeals/{appealId}/accept": "EntryReviewDecision",
  "POST /api/v1/moderation/appeals/{appealId}/reject": "EntryReviewDecision",
  ...
  "POST /api/v1/admin/seed-entries/{entryId}/suppress": "ModerationReason",
  "POST /api/v1/admin/seed-entries/{entryId}/restore": "ModerationReason",
  ...
  "POST /api/v1/admin/agent-runtime/capability-package": "RuntimeCapabilityPackage",
...
const idempotentOperations = new Set([
  ...
  "POST /api/v1/reports",
  "POST /api/v1/entries/{entryId}/revival-requests",
  ...
  "POST /api/v1/moderation/appeals/{appealId}/reject",
  ...
  "POST /api/v1/admin/seed-entries/{entryId}/suppress",
  "POST /api/v1/admin/seed-entries/{entryId}/restore",
