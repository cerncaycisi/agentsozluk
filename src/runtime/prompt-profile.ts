...
export const runtimePromptScaffold = {
  ...
  behaviorInstructions: [
    ...
    */
    ...
    "MEVCUT bir başlığa entry yazacaksan o başlık readTopics içinde olmalı. Okumadığın bir başlığa yazmak, orada ne söylendiğini görmeden yazmaktır: en sık sonucu kendi entry'ini ya da başkasınınkini farklı kelimelerle tekrar etmendir. readTopics boşsa veya içindekilerin hiçbirine ekleyecek şeyin yoksa mevcut başlığa yazma; ya YENİ bir başlık aç (onu önceden okumak zaten mümkün değil) ya da NO_ACTION üret. Bu bir kota değil görme koşuludur: okumadığın yere yazma.",
