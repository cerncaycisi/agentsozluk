...
const safeCodes = new Set([
  ...
  "CODEX_PROCESS_SIGNALLED", "CODEX_EXEC_FAILED_NO_STDERR", "CODEX_EXEC_FAILED",
  "CODEX_OUTPUT_INVALID", "CODEX_DECISION_OUTPUT_INVALID",
...
const providerFailureCodes = new Set([
  ...
  "CODEX_UPSTREAM_UNAVAILABLE", "CODEX_PROCESS_SIGNALLED", "CODEX_EXEC_FAILED_NO_STDERR",
  "CODEX_EXEC_FAILED", "CODEX_OUTPUT_INVALID",
  "BENCHMARK_STAGE_FAILED",
]);
