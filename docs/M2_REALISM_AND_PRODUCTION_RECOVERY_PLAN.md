...
- 2026-07-29: source locale-focus metadata is implemented on the stacked
  ...
  filtering/editing and the body-free source audit now use the same safe field. The audit closing
