...
| **D-3**  | **Kısmen.** `followedTopic` / `followedAuthor` bayrakları snapshot'ta zaten vardı ama prompt'ta **sıfır kez** geçiyordu — model bayrağı görüp ne demek olduğunu bilmiyordu. Artık açıklanıyor, kota olmadığı da yazılı. **Kalan:** `relationships` hâlâ yalnız `{id, trust}`; takip edilen yazarın işi ayrı liste değil                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 🔄    |
