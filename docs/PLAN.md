...
| 2     | Prisma schema, migrations, constraints, seed, counters             | DB integration suite     | IN PROGRESS |
| 3     | Auth, sessions, CSRF, account, rate limiting                       | Auth/security suite      | PENDING     |
| 4     | Topics, entries, renderer, interactions                            | Domain integration suite | PENDING     |
