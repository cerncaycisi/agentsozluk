...
- [~] **Lease süresi alarmı — dalda (`ops/lease-alarmi`, PR #154).** Telemetri
  ...
  Astra'nın; "5 dk'da 3 kez" timer aralığına uyarlanıp 15 dk oldu.
      ...
      **Astra kurulum turu KURMA, ardından Sol:** sabit 15 dk'lık pencere olay kaçırıyordu, gönderilemeyen bildirim kayboluyordu, sayı ortasında kesik satır sahte düzelme üretiyordu; ilk imleç denemesinde de (Sol) 6 saatten uzun başarısız gönderim olayı kaybediyor, örtüşme eşiği bozuyordu. **Tespit ile teslim ayrıldı:** gönderilemeyen karar diskte kuyruğa yazılır, her koşu önce kuyruğu sırayla boşaltır; imleç her başarılı log okumasından sonra ilerler (en fazla 6 sa geri, okunamazsa ilerlemez). Yalnız imleçten sonraki kayıtlar sayılır; "3 yavaş" gerçek 15 dk'lık kayan pencerede, yalnız yeni bir kayıtla biten pencerede aranır (taramaya bölünen seri yakalanır, eski seri yeniden alarm üretmez). Kayıt `time` taşımalı ve `}` ile bitmeli. 43 test; mutasyon taramasında kaçan tek mutant eşdeğer (sayı kapanış kontrolü, satır sonu kontrolüyle zaten kapsanıyor).
